...
syn match   deperlLine ";.*"lc=1
syn match   deperlLine excludenl "*;"
"syn match   deperlLine "[a-zA-Z0-9_]\+$[a-zA-Z0-9_]\+\>.*"
syn match   deperlLine "[a-zA-Z0-9_]\+$[a-zA-Z0-9_$]\+\>"
"syn match   deperlLine "[a-zA-Z0-9_]$\+\<"
...
if version >= 508 || !exists("did_verilog_syn_inits")
   ...
   HiLink deperlLine		 PreProc

   delcommand HiLink
endif

let b:current_syntax = "deperl"
