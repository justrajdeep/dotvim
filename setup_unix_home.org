...
unalias llfy; alias lly 'ls-F --color=always -ltrh `( $HOME/scripts/bin/cdf_command \!:1 ; $HOME/scripts/bin/ag_file_command \!:1 ) | $HOME/scripts/bin/fzy`'
# current directory
...
unalias vmz; alias vmz '$HOME/scripts/downloaded/vimer -t -s \!:1 `$HOME/scripts/bin/ag_file_command . | $HOME/scripts/bin/fzf`'
unalias vmy; alias vmy '$HOME/scripts/downloaded/vimer -t -s \!:1 `$HOME/scripts/bin/ag_file_command . | $HOME/scripts/bin/fzy`'
# project specific
...
unalias vmpz; alias vmpz '$HOME/scripts/downloaded/vimer -t -s \!:1 `$HOME/scripts/bin/ag_file_command $STEM/src/ | $HOME/scripts/bin/fzf`'
unalias vmpy; alias vmpy '$HOME/scripts/downloaded/vimer -t -s \!:1 `$HOME/scripts/bin/ag_file_command $STEM/src/ | $HOME/scripts/bin/fzy`'
unalias vmoz; alias vmoz '$HOME/scripts/downloaded/vimer -t -s \!:1 `$HOME/scripts/bin/ag_file_command $OUT_HOME/ | $HOME/scripts/bin/fzf`'
unalias vmoy; alias vmoy '$HOME/scripts/downloaded/vimer -t -s \!:1 `$HOME/scripts/bin/ag_file_command $OUT_HOME/ | $HOME/scripts/bin/fzy`'
...
unalias createVnc; alias createVnc 'vncserver :\!:1 -depth 24 -geometry 3820x1025 --alwaysshared -log \*:stdout:0'
