...
#+BEGIN_SRC sh :tangle ~/scripts/bin/cgb :shebang "#!/tool/pandora64/.package/perl-5.24.0-gcc620/bin/perl" :eval no
...
# #+END_SRC
* set the defatult colors
#+BEGIN_SRC tcsh :shebang "#!/bin/sh" :tangle ~/.dircolors :eval never
...
: Requirement already up-to-date: powerline-shell in /home/ramondal/.local/lib/python2.7/site-packages
: Requirement already up-to-date: argparse in /home/ramondal/.local/lib/python2.7/site-packages (from powerline-shell)

** install config.json
#+BEGIN_SRC sh :results output :dir ~/ :eval no :tangle ~/.config/powerline-shell/config.json
{
  "segments": [
    {
      "type": "env",
...
** install uptime
#+BEGIN_SRC sh :results output :dir ~/ :eval no :tangle ~/.config/powerline-shell/my_uptime.py
import subprocess
import re
...
** install git
#+BEGIN_SRC sh :results output :dir ~/ :eval no :tangle ~/.config/powerline-shell/my_git.py
import re
import subprocess
import yaml
...
** install git_stash
#+BEGIN_SRC sh :results output :dir ~/ :eval no :tangle ~/.config/powerline-shell/my_git_stash.py
import re
import subprocess
import yaml
...
** install time
#+BEGIN_SRC sh :results output :dir ~/ :eval no :tangle ~/.config/powerline-shell/my_time.py
...
** install cwd
#+BEGIN_SRC sh :results output :dir ~/ :eval no :tangle ~/.config/powerline-shell/my_cwd.py
import os
import sys
import yaml
...
** install history
#+BEGIN_SRC sh :results output :dir ~/ :eval no :tangle ~/.config/powerline-shell/my_history_count.py
from powerline_shell.utils import BasicSegment
...
** install newline
#+BEGIN_SRC sh :results output :dir ~/ :eval no :tangle ~/.config/powerline-shell/my_newline.py
